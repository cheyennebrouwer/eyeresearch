...
De data uit het literatuuronderzoek en het eigen onderzoek zijn met elkaar vergeleken om te kijken of er verschillen in de waarnemingen zitten met behulp van de chi square test.
...
```
Er is ook een histogram geplot om een betere visualisatie te zien van de data uit de twee onderzoeken. 
...
Conclusie: De p-waarde uit de chi square test is p=1,837e-13 (met een α van 0.05) en is dus zeer klein. Hierdoor kan H0 ("De gegevens komen niet overeen met de bekende literatuur voor populatie oogkleur bij Nederlanders") worden verworpen en H1 ("De gegevens komen overeen met de bekende literatuur voor populatie oogkleur bij Nederlanders") aangenomen worden. Er zit een significant verband tussen de data uit het literatuuronderzoek en het eigen onderzoek. 
