...
\begin{figure}
\includegraphics[width=1\linewidth]{eyecolor_files/figure-latex/plot-data-literatuur-verg-1} \caption{Barplot van totaal geobserveerde(frequentie) aantal per oogkleur over alle meerderheid gekozen oogkleuren.}\label{fig:plot-data-literatuur-verg}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.33\linewidth]{eyecolor_files/figure-latex/hanze-pie-chart-1} \caption{Drie taart grafieken die de tellingen tussen de oogkleuren per locatie vergelijken.}\label{fig:hanze-pie-chart-1}
\end{figure}
\begin{figure}
\includegraphics[width=0.33\linewidth]{eyecolor_files/figure-latex/hanze-pie-chart-2} \caption{Drie taart grafieken die de tellingen tussen de oogkleuren per locatie vergelijken.}\label{fig:hanze-pie-chart-2}
\end{figure}
\begin{figure}
\includegraphics[width=0.33\linewidth]{eyecolor_files/figure-latex/hanze-pie-chart-3} \caption{Drie taart grafieken die de tellingen tussen de oogkleuren per locatie vergelijken.}\label{fig:hanze-pie-chart-3}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{eyecolor_files/figure-latex/sexe-oogkleur-barplot-1} \caption{Barplot aantal oogkleuren per geslacht alle locaties samen. Verdeeld onder sexe.}\label{fig:sexe-oogkleur-barplot}
\end{figure}
