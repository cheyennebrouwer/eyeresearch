...
\begin{figure}
\includegraphics[width=0.33\linewidth]{eyecolor_files/figure-latex/hanze-pie-chart-1} \caption{Taart grafiek die de verdeling van de oogkleur op de Hanze Hogeschool Groningen weergeeft.}\label{fig:hanze-pie-chart-1}
\end{figure}
\begin{figure}
\includegraphics[width=0.33\linewidth]{eyecolor_files/figure-latex/hanze-pie-chart-2} \caption{Taart grafiek die de verdeling van de oogkleur op de Hanze Hogeschool Groningen weergeeft.}\label{fig:hanze-pie-chart-2}
\end{figure}
\begin{figure}
\includegraphics[width=0.33\linewidth]{eyecolor_files/figure-latex/hanze-pie-chart-3} \caption{Taart grafiek die de verdeling van de oogkleur op de Hanze Hogeschool Groningen weergeeft.}\label{fig:hanze-pie-chart-3}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{eyecolor_files/figure-latex/sexe-oogkleur-barplot-1} \caption{Aantallen per oogkleur en geslacht: In deze barplot is per geslacht weergegeven hoe vaak een oogkleur is gemeten}\label{fig:sexe-oogkleur-barplot}
\end{figure}
