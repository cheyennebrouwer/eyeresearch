...
# bibliography: Scientific_paper.bib # naam van je .bib file. Deze moet hetzelfde zijn als je Rmd bestandsnaam
...
De `chi-squar` p-waarde tussen de percentages uit het literatuuronderzoek en eigen onderzoek is 1.837e-13 (α = .05). Om antwoord te krijgen of de Hanze aanleg heeft voor een bepaalde oogkleur zijn ook de locaties vergeleken.
...
```{r, hanze-gender-pie-chart, fig.cap='Drie barplots met aantallen per oogkleur per locatie, onder drie gemeten locaties. Verdeeld onder sexe.' , out.width="33%" }
