...
Hier is te zien hoe blauw (52,5%) het grootste deel van de metingen uitmaakt, gevolgd door bruin (34,17%) en groen (8,33%). Zonder de "undefined" waarden meegerekend komt dit neer op de verhoudingen blauw, bruin, groen van respectievelijk 55,26%, 35,96% en 8,77%.
...
```{r sexe-oogkleur-barplot, fig.cap='Barplot met aantal oogkleuren per geslacht van alle meet- locaties samen. Verdeeld onder sexe.'}
...
Bij de oogkleuren bruin en hazel is er geen significant verschil tussen mannen en vrouwen (chi-square test p-waarde - 0,57 bij alfa = 0.05). Daarnaast zijn er geen andere grote verschillen tussen sexe en de oogkleuren. Maar dat kan niet worden meegenomen in dit onderzoek.
...
Gebruikte versie: 4.4.07.24

Referentie: <https://play.google.com/store/apps/details?id=com.samsung.android.app.notes&hl=en&gl=US>
