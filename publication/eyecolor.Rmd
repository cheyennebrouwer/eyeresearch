...
```{r plot-data-literatuur-verg, fig.cap='Barplot van totaal geobserveerde(frequentie) aantal per oogkleur over alle meerderheid gekozen oogkleuren.'}
...
NA-waarden meegerekend komt dat neer op de verhoudingen blauw, bruin,
groen (55,26%, 35,96% en 8,77%).

```{r plot-litr_data-data-literatuur-verg, fig.cap='Barplot met oogkleur in percentage voorkomst en oogkleur percentage uit data uit de literatuur. Meerderheid waargenomen door analisten van het rechter oogkleur. Oogkleur percentages van de literatuur gevonden op fsigenetics - "True colors: A literature review on the spatial distribution of eye and hair pigmentation" via researchgate'}
...
In de barplot hierboven staat data van dit onderzoek en uit een paper
die informatie over de verdeling van de oog- en haarkleur heeft
verzamelen over populaties en deze data als een blue-print te gebruiken
om de nauwkeurigheid van voorspellingen op basis van DNA te
verbeteren.[@Katsara2019tc] Dit onderzoek heeft meerdere datasets,
waaruit 3 percentages zijn gehaald voor vergelijking met dit onderzoek.
Deze percentages geven de prevalentie van de 3 oogkleuren aan in
Nederland breed. De kleur blauw(60.9%) was hieruit de meest voorkomende
oogkleur volgens de literatuur; meer dan dit onderzoek suggereert. Bruin
is Nederland breed minder prevalant dan bij dit onderzoek en bij de
kleur groen is dat andersom. De chi-square p-waarde tussen de
percentages van Nederland breed en onze locaties is 1.837e-13 (α = .05).
...
```{r, hanze-pie-chart, fig.cap='Drie taart grafieken die de tellingen tussen de oogkleuren per locatie vergelijken.', out.width="33%"}
ggplot(data = Hanze, 
...
24% tussen alle opnames, kunnen deze waarnemingen toeval zijn. In Zwolle
...
```{r, hanze-gender-pie-chart, fig.cap='Drie barplots met aantallen per oogkleur per locatie, onder drie gemeten locaties. Verdeeld onder sexe.', eval=FALSE, out.width="33%"}
...
```{r sexe-oogkleur-barplot, fig.cap='Barplot aantal oogkleuren per geslacht alle locaties samen. Verdeeld onder sexe.'}
