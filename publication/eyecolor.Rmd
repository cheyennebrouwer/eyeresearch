...
voor heeft zijn er word er eerst gekeken of er een significante meetfout
is gevormd. Dit is met behulp van een tabel met het aantal opnamen per
...
test. Dan word er het verschil met Nederland behandeld voor extra
controle op de significantie van deze data en als een extra vergelijking
hoe de Hanzehogeschool opweegt tegen het gemiddelde van de Nederlandse
bevolking. Vervolgens worden de locatie factoren aan het licht gebracht,
de sexe verdeling per locatie en tenslotte de sexe verdeling over het
algemeen. Allemaal tegen op de oogkleur.
...
```{r analist-oogkleur-chi-square, fig.cap='De geobserveerde aantal oogkleuren per analist. Links en rechts gecombineerd. '}
